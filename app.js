/* ================================================================== *
 *  Danique, Run Coach, sterker worden richting comfortabel 15 km
 *  14-weken opbouw, 3 vaste loopdagen (ma/wo/za), naast pilates.
 *  Warm-weer-bewust. Richting de Bruggenloop (15 km) als ze wil.
 * ================================================================== */
...
const CONFIG = {
  ...
  zonePaceSuffix: "/km",
  footEmoji:  "🏃‍♀️",
  mottos: ["Zet 'm op, strijder!", "Lekker bezig, strijder!", "Je bouwt 'm mooi op, strijder.", "Halverwege, knap volgehouden! ⚡", "Bijna bij je 15 km, strijder!", "15 km gelopen! Wat een strijder! 🎉"],
  appName:    "Op naar 15K",
  runner:     "Danique",
  goal:       "Comfortabel 15 km lopen",
  startDate:  new Date(2026, 7, 17),
  storeKey:   "danique.log.v1",
...
const ZONES = [
  ...
  { key: "lang",     name: "Lange duurloop",  pace: "6:20–6:55",          info: "RPE 3-4 · tijd op de benen" },
  { key: "doel",     name: "Duurtempo (15 km)", pace: "5:50–6:10",        info: "RPE 5-6 · vlot maar vol te houden" },
  { key: "tempo",    name: "Drempel / tempo", pace: "5:25–5:45",          info: "RPE 6-7 · stevig, comfortabel zwaar" },
  { key: "interval", name: "Interval",        pace: "5:00–5:20",          info: "RPE 8 · scherp, nooit sprinten" },
];
...
const COACH = {
  duur: [
    ...
    "Praten moet makkelijk kunnen. Zachte pas, ontspannen schouders.",
    "Tachtig procent van je werk hoort zo rustig te voelen. Mooi bezig.",
  ],
  lang: [
    "De lange duurloop, strijder. Het hart van je opbouw richting 15 km.",
    "Rustig starten, sterk eindigen. Neem onderweg wat te drinken mee.",
    "Tijd op de benen betaalt zich uit. Elke kilometer maakt 15 km lichter.",
    "Soepele pas, hoofd rustig. Jij komt verder dan je denkt.",
  ],
  tempo: [
    "Drempeltraining, strijder. Stevig, maar netjes onder controle.",
    "Comfortabel zwaar, daar verleg je je grens. Gelijkmatig blijven.",
    "Net onder het verzuren. Hier wordt je duurtempo lichter.",
    "Beheerst doorzetten, strijder. Je tilt je hele niveau omhoog.",
  ],
  interval: [
    "Intervallen, strijder. Korte inspanningen, goed herstellen ertussen.",
    "Houd elke herhaling gelijk en soepel. Let op je looptechniek.",
    "Even pittig, dan rust. Jij hebt dit onder controle, strijder.",
    "Scherp en gecontroleerd, nooit sprinten. Hier komt je snelheid vandaan.",
  ],
  doel: [
    "Duurtempo, strijder. Dit is het ritme dat je op 15 km wilt vasthouden.",
    "Vlot, maar comfortabel. Onthoud hoe dit voelt, hier doe je het voor.",
    "Beheerst op tempo blijven. Precies waar je 15 km straks op leunt.",
    "Voel je duurtempo, strijder. Vol te houden, dat is de kunst.",
  ],
  herstel: [
...
const DONE = [
  ...
  "🔥 Weer eentje afgevinkt, op naar je 15 km!",
...
const WHY = {
  duur:     "Rustige duurlopen bouwen je aerobe motor: sterker hart, meer haarvaten en betere vetverbranding. Het grootste deel van je week hoort hier rustig te zijn, zo verdraag je de opbouw zonder blessures.",
  lang:     "De lange duurloop is de ruggengraat van je 15 km. Je traint uithoudingsvermogen en het mentale doorlopen. Houd je pas soepel en rustig, dan groeit je afstand vanzelf mee.",
  tempo:    "Drempellopen liggen rond je omslagpunt. Je leert sneller lopen zonder te verzuren, waardoor je duurtempo op 15 km steeds lichter gaat voelen.",
  ...
  doel:     "Lopen op je duurtempo maakt dat ritme vertrouwd. Doe je dit vaak, dan voelt 15 km op een vlot maar houdbaar tempo straks vanzelfsprekend in plaats van een gok.",
  herstel:  "Herstel is waar je sterker wordt. Lichte inspanning houdt het bloed stromen zonder nieuwe belasting, zodat de winst van je zware dagen en je pilates echt binnenkomt.",
};

/* --- 3 vaste loopdagen: ma, wo, za (za = lange loop / finale) ------ */
...
const PLAN = [
  { week: 1, dates: "17–23 aug", phase: "Fase 1 · Basis leggen", sessions: [
    ma({ zone: "duur",  km: 6,  title: "6 km rustig",       goal: "Rustig aan je vaste ritme wennen", blocks: ["6 km op 6:15–6:45/km", "Ontspannen, zachte pas"] }),
    wo({ zone: "tempo", km: 6,  title: "5×2 min vlot",      goal: "Aan tempo wennen", blocks: ["1,5 km inlopen + 4 versnellingen", "5×2 min vlot (~5:35/km)", "2 min dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 12, title: "12 km rustig",      goal: "Vertrouwde lange duur", blocks: ["12 km op 6:20–6:55/km", "Rustig starten, sterk eindigen"] }),
  ]},
  { week: 2, dates: "24–30 aug", phase: "Fase 1 · Basis leggen", sessions: [
    ma({ zone: "duur",  km: 6,  title: "6 km rustig",       goal: "Herstel & volume", blocks: ["6 km op 6:15–6:45/km"] }),
    wo({ zone: "tempo", km: 7,  title: "2×2 km drempel",    goal: "Drempel aanspreken", blocks: ["2 km inlopen + 3 versnellingen", "2×2 km @ 5:25–5:45/km", "3 min dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 13, title: "13 km rustig",      goal: "Duur opbouwen", blocks: ["13 km op 6:20–6:55/km", "Drinken oefenen onderweg"] }),
  ]},
  { week: 3, dates: "31 aug–6 sep", phase: "Fase 1 · Basis leggen", sessions: [
    ma({ zone: "duur",  km: 7,  title: "7 km rustig",       goal: "Volume", blocks: ["7 km op 6:15–6:45/km"] }),
    wo({ zone: "interval", km: 7, title: "5×600 m interval", goal: "VO2max prikkelen", blocks: ["1,5 km inlopen + 4 versnellingen", "5×600 m @ 5:00–5:20/km", "400 m dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 14, title: "14 km rustig",      goal: "Langer op de benen", blocks: ["14 km op 6:20–6:55/km", "Laatste 2 km iets vlotter op gevoel"] }),
  ]},
  { week: 4, dates: "7–13 sep", phase: "Fase 1 · Basis leggen", recovery: true, sessions: [
    ma({ zone: "herstel", km: 6, title: "6 km heel rustig", goal: "Herstelweek, bijtanken", blocks: ["6 km, langzamer dan 7:00/km"] }),
  ...
  { week: 5, dates: "14–20 sep", phase: "Fase 2 · Duurtempo erin", sessions: [
    ma({ zone: "duur",  km: 7,  title: "7 km rustig",       goal: "Volume", blocks: ["7 km op 6:15–6:45/km"] }),
    wo({ zone: "doel",  km: 8,  title: "5 km op duurtempo", goal: "Race-ritme aanleren", blocks: ["2 km inlopen", "5 km @ 5:50–6:10/km", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 14, title: "14 km rustig",      goal: "Duur vasthouden", blocks: ["14 km op 6:20–6:55/km", "Voeding & drinken oefenen"] }),
  ]},
  { week: 6, dates: "21–27 sep", phase: "Fase 2 · Duurtempo erin", sessions: [
    ma({ zone: "duur",  km: 7,  title: "7 km rustig",       goal: "Volume", blocks: ["7 km op 6:15–6:45/km"] }),
    wo({ zone: "tempo", km: 8,  title: "3×2 km drempel",    goal: "Drempelvolume", blocks: ["2 km inlopen", "3×2 km @ 5:25–5:45/km", "3 min dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 15, title: "15 km rustig",      goal: "Je eerste 15 km!", blocks: ["15 km op 6:20–6:55/km", "Rustig, dit mag makkelijk voelen"] }),
  ]},
  { week: 7, dates: "28 sep–4 okt", phase: "Fase 2 · Duurtempo erin", sessions: [
    ma({ zone: "duur",  km: 8,  title: "8 km rustig",       goal: "Volume", blocks: ["8 km op 6:15–6:45/km"] }),
    wo({ zone: "interval", km: 8, title: "6×600 m interval", goal: "Scherpte", blocks: ["1,5 km inlopen", "6×600 m @ 5:00–5:20/km", "400 m dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 15, title: "15 km rustig",      goal: "Duur vasthouden", blocks: ["15 km op 6:20–6:55/km"] }),
  ]},
  { week: 8, dates: "5–11 okt", phase: "Fase 2 · Duurtempo erin", recovery: true, sessions: [
    ma({ zone: "herstel", km: 6, title: "6 km heel rustig", goal: "Herstelweek", blocks: ["6 km, langzamer dan 7:00/km"] }),
    wo({ zone: "duur",    km: 7, title: "7 km + 6 strides", goal: "Los blijven", kind: "Soepel", blocks: ["7 km rustig", "6×100 m soepel"] }),
    za({ zone: "lang",    km: 12, title: "12 km ontspannen", goal: "Herstel", blocks: ["12 km laag in zone 2"] }),
  ]},
  { week: 9, dates: "12–18 okt", phase: "Fase 3 · Specifiek 15 km", sessions: [
    ma({ zone: "duur",  km: 8,  title: "8 km rustig",       goal: "Volume", blocks: ["8 km op 6:15–6:45/km"] }),
    wo({ zone: "doel",  km: 9,  title: "8 km op duurtempo", goal: "Lang op race-ritme", blocks: ["1,5 km inlopen", "8 km @ 5:50–6:10/km", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 16, title: "16 km rustig",      goal: "Langste loop, de piek", blocks: ["16 km op 6:20–6:55/km", "Halverwege wat drinken, ritme bewaken"] }),
  ]},
  { week: 10, dates: "19–25 okt", phase: "Fase 3 · Specifiek 15 km", sessions: [
    ma({ zone: "duur",  km: 8,  title: "8 km rustig",       goal: "Volume", blocks: ["8 km op 6:15–6:45/km"] }),
    wo({ zone: "tempo", km: 9,  title: "2×3 km drempel",    goal: "Drempel verlengen", blocks: ["2 km inlopen", "2×3 km @ 5:30–5:45/km", "3 min dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "doel",  km: 15, title: "15 km met 5 km duurtempo", goal: "Sleutelloop", blocks: ["10 km op 6:20–6:55/km", "5 km @ 5:50–6:10/km", "Voeding als op racedag"] }),
  ]},
  { week: 11, dates: "26 okt–1 nov", phase: "Fase 3 · Specifiek 15 km", sessions: [
    ma({ zone: "duur",  km: 7,  title: "7 km rustig",       goal: "Volume", blocks: ["7 km op 6:15–6:45/km"] }),
    wo({ zone: "interval", km: 9, title: "5×800 m interval", goal: "Snelheid scherp houden", blocks: ["2 km inlopen", "5×800 m @ 5:00–5:15/km", "400 m dribbel ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 15, title: "15 km comfortabel", goal: "Vertrouwen op de afstand", blocks: ["15 km op 6:20–6:55/km"] }),
  ]},
  { week: 12, dates: "2–8 nov", phase: "Fase 4 · Afbouw & scherpte", recovery: true, sessions: [
    ma({ zone: "duur",  km: 6,  title: "6 km rustig",       goal: "Volume omlaag", blocks: ["6 km op 6:15–6:45/km"] }),
    wo({ zone: "doel",  km: 7,  title: "4 km op duurtempo", goal: "Ritme scherp houden", blocks: ["1,5 km inlopen", "4 km @ 5:50–6:10/km", "1,5 km uitlopen"] }),
    za({ zone: "lang",  km: 12, title: "12 km soepel",      goal: "Rustige lange loop", blocks: ["12 km op 6:20–6:55/km"] }),
  ]},
  { week: 13, dates: "9–15 nov", phase: "Fase 4 · Scherp & fris", sessions: [
    ma({ zone: "duur",  km: 6,  title: "6 km rustig",       goal: "Benen los", blocks: ["6 km op 6:15–6:45/km"] }),
    wo({ zone: "tempo", km: 7,  title: "3×1 km scherp",     goal: "Scherp & fris", blocks: ["1,5 km inlopen + 3 versnellingen", "3×1 km @ 5:25–5:35/km", "2 min rust ertussen", "1 km uitlopen"] }),
    za({ zone: "lang",  km: 13, title: "13 km soepel",      goal: "Laatste wat langere loop", blocks: ["13 km op 6:20–6:55/km"] }),
  ]},
  { week: 14, dates: "16–22 nov", phase: "Fase 4 · Finale", finish: true, sessions: [
    ma({ zone: "duur", km: 5, title: "5 km rustig",         goal: "Benen los houden", blocks: ["5 km op 6:20–6:55/km", "Ontspannen, niets forceren"] }),
    wo({ zone: "doel", km: 5, title: "3 km los + 2 km duurtempo", goal: "Scherp & fris", kind: "Soepel", blocks: ["3 km rustig + 4×100 m strides", "2 km @ 5:50–6:10/km om het ritme te voelen"] }),
    za({ zone: "doel", km: 15, title: "🏁 15 km", finish: true, goal: "Jouw mijlpaal · comfortabel uitlopen", kind: "Finale", blocks: ["Eerste 3 km bewust rustig starten", "Settle op je duurtempo 5:50–6:10/km, of gewoon op gevoel", "Onderweg wat drinken", "Laatste 3 km: geef wat je over hebt", "Geniet ervan, dit is jouw dag! 🎉"] }),
  ]},
];

const INFO = [
  { icon: "🥵", title: "Lopen in warm weer", items: [
    "Loop op warme dagen vroeg in de ochtend of laat op de avond, dan is het koeler.",
    "Laat het tempo los en stuur op gevoel: bij warmte voelt hetzelfde tempo veel zwaarder, en dat is normaal.",
    "Drink extra, ook vóór je gaat, en neem bij lange lopen wat mee (met warmte eventueel elektrolyten).",
    "Voelt het echt niet lekker? Kort de loop in, verplaats 'm of maak er een rustige duurloop van. Niks om je voor te schamen." ] },
  { icon: "🧘", title: "Pilates: jouw kracht erbij", items: [
    "Pilates is top voor je core en stabiliteit, precies wat een sterke, ontspannen loophouding vraagt.",
    "Plan je pilates op een niet-loopdag, en het liefst niet vlak vóór je lange loop op zaterdag.",
    "Voelt een les pittig in de benen? Houd je loopje die dag dan rustig.",
    "Je hoeft er niets voor te laten: het maakt je juist minder blessuregevoelig." ] },
  { icon: "🥤", title: "Voeding & drinken", items: [
    "Lange lopen langer dan 75 min: 400 tot 600 ml per uur, bij warmte met elektrolyten.",
    "Op de langste lopen (14 tot 16 km) mag je 1 gel of iets kleins met koolhydraten oefenen.",
    "Voor de meeste 15 km-lopen heb je onderweg genoeg aan water en eventueel 1 gel.",
  ...
  { icon: "🔥", title: "Warming-up & afkoelen", items: [
    ...
    "Je pilates helpt hier ook mee: soepele heupen en een stabiele romp." ] },
  { icon: "🎯", title: "Naar 15 km (en misschien de Bruggenloop)", items: [
    "Dit blok bouwt je rustig naar comfortabel 15 km. De laatste zaterdag is jouw mijlpaal.",
    "15 km is precies de afstand van de Bruggenloop in Rotterdam (december). Wil je die lopen, dan sta je er klaar voor.",
    "Kies je een echte racedatum? Dan schuiven we het schema er samen netjes naartoe.",
    "Geen tijdsdruk: sterk en ontspannen uitlopen is de winst." ] },
  { icon: "😴", title: "Rust & geduld", items: [
    "Minstens één echte rustdag per week; wandelen of fietsen mag op tussendagen.",
    "Twee loopjes in een drukke week is prima: houd dan de maandag en de zaterdag aan.",
    "Slaap is je beste herstelmiddel, zeker in de opbouwweken.",
    "Een mindere dag is normaal, strijder. Blijf rustig doorbouwen." ] },
];
...
const BADGES = [
  ...
  { id: "long",   icon: "🏔️", name: "Lange loper",       desc: "≥ 15 km gelogd",         test: (s) => s.maxDist >= 15 },
  ...
  { id: "finish", icon: "🎉",  name: "15 km-finisher",    desc: "De 15 km voltooid",      test: (s) => s.raceDone },
];
