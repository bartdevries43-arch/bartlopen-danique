...
const CACHE = "runcoach-danique-v1-m2-bugfix-schuifmelding-opslag-aftel";
const ASSETS = ["./","./index.html","./styles.css?v=1-m2-bugfix-schuifmelding-opslag-aftel","./app.js?v=1-m2-bugfix-schuifmelding-opslag-aftel","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
