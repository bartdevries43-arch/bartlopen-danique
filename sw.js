...
const CACHE = "runcoach-danique-v1-m2-bugfix-schuifmelding";
const ASSETS = ["./","./index.html","./styles.css?v=1-m2-bugfix-schuifmelding","./app.js?v=1-m2-bugfix-schuifmelding","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
